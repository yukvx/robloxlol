loadstring(game:HttpGet("https://raw.githubusercontent.com/yukvx/Kazusa.club/refs/heads/main/library/luaDrawingF.lua"))()
local Start = tick()
local LoadTime = tick()
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Gradient = Utility.AddImage("Abyss/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/yukvx/cat.girl/refs/heads/main/library%20assets/gradientL2R.png")
